...
-- CreateTable
CREATE TABLE "SpaceListeningHistory" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "SpaceListeningHistory_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "SongMetadata_extractedId_key" ON "SongMetadata"("extractedId");

-- CreateIndex
CREATE UNIQUE INDEX "space_extracted_unique" ON "SpaceListeningHistory"("spaceId", "extractedId");

-- CreateIndex
CREATE UNIQUE INDEX "UserSongPreference_userId_extractedId_key" ON "UserSongPreference"("userId", "extractedId");
