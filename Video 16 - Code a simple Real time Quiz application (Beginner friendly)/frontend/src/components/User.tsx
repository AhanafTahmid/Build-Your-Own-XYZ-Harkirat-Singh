...
export const UserLoggedin = ({name, code}:{name: string, code: string}) => {
    ...
    const [currentQuestion, setCurrentQuestion] = useState<{id: string, description: string, options: Array<string>} | null>(null);
    const [leaderboard, setLeaderboard] = useState(Array<{name:string, points:number, profilePicture:string}>);
