...
//10 quantity 200 er moddhe chaile ase naki dekha
//providing its latest price information, usually as a two-sided market (bid/ask), not just the last traded price.
app.get("/quote", (req, res) => {

   let highestBid = 0;
   let lowestAsk = 1000000;
   //console.log("1111111", bb);
    if (bids.length > 0) {
